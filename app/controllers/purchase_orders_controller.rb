class PurchaseOrdersController < ApplicationController
  ...
  private
    ...
    def purchase_order_params
      params.require(:purchase_order).permit(:order_num, :purchase_date, :status, :sales_channel, :order_total, :num_items_shipped, :num_items_unshipped, :payment_method, :shipped_at, :shipping_price, :shipping_tax, :carrier, :tracking_number, :est_arrival_date, :fulfillment_center, :confirnmed_at, :returned_date, :return_reason, :notes, :refunded_at, :ship_to_name, :ship_to_address)
    end
end
