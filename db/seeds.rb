...
5000.times do
  ...
  PurchaseOrder.create    order_num: "#{Faker::Number.number(digits: 3)}-#{Faker::Number.number(digits: 7)}-#{Faker::Number.number(digits: 7)}",
                          purchase_date: purchase_date,
                          status: order_type,
                          sales_channel: %w[amazon.com ebay.com walmart.com amazon.de].sample,
                          ...
                          est_arrival_date: estimated_arrival_date,
